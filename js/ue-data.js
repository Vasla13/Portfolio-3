window.UE_CONTENT = {
        ...
        resources: [
            {
                ...
                items: [
                    { code: "R1.01", text: "Initiation reseaux" },
                    { code: "R1.03", text: "Reseaux locaux (LAN)" },
                    { code: "R1.08", text: "Bases OS (Linux/Windows)" },
                    { code: "R2.01", text: "Techno Internet" },
                    { code: "R2.02", text: "Admin Sys et Virtualisation" }
                ]
            },
            {
                label: "Semestres 3 et 4",
                items: [
                    { code: "R3.01", text: "Reseaux de Campus" },
                    { code: "R3.02", text: "Reseaux Operateurs (WAN)" },
                    { code: "R3.04", text: "Services d'annuaires (AD)" },
                    { code: "R4.01", text: "Architecture Avancee" }
                ]
            },
            {
                label: "Semestre 5",
                ...
                items: [
                    ...
                    { code: "R5.03", text: "Ingenierie Telecoms" },
                    { code: "R5.Cyber.09", text: "Archis Securisees" }
                ]
            }
        ],
        resourceBadge: "En cours d'acquisition",
        saeTitle: "SAE Realisees",
        saeItems: [
            { text: "SAE 1.02 : S'initier aux reseaux informatiques" },
            { text: "SAE 2.01 : Construire un reseau pour une PME" },
            { text: "SAE 3.03 : Concevoir un reseau securise multi-sites" },
            { text: "SAE 5.01 : CyberFi - Architecture IoT Securisee", highlight: true }
        ],
        objectivesTitle: "Objectifs Programme National",
    ...
    ue2: {
        ...
        resources: [
            {
                label: "Semestres 1 et 2",
                items: [
                    { code: "R1.02", text: "Principes et Archi Reseaux" },
                    { code: "R1.13", text: "Maths du signal" },
                    { code: "R2.01", text: "Techno de l'Internet" },
                    { code: "R2.04", text: "Telephonie d'entreprise" },
                    { code: "R2.05", text: "Signaux et Systemes" }
                ]
            },
            {
                label: "Semestres 3 et 4",
                items: [
                    { code: "R3.02", text: "Reseaux Operateurs" },
                    { code: "R3.05", text: "Telephonie et VoIP" },
                    { code: "R3.06", text: "Fibre Optique et Acces" },
                    { code: "R4.03", text: "Reseaux WAN et SD-WAN" }
                ]
            },
            {
                label: "Semestre 5",
        ...
        saeTitle: "SAE Realisees",
        saeItems: [
            { text: "SAE 1.02 : S'initier aux reseaux" },
            { text: "SAE 2.02 : Caracteriser des signaux" },
            { text: "SAE 3.02 : Deployer de la ToIP" },
            { text: "SAE 5.01 : CyberFi (Transmission de donnees)", highlight: true }
        ],
        objectivesTitle: "Objectifs Programme National",
    ...
    ue3: {
        ...
        resources: [
            {
                label: "Semestres 1 et 2",
                items: [
                    { code: "R1.07", text: "Fondamentaux Prog" },
                    { code: "R1.09", text: "Dev Web (HTML/CSS)" },
                    { code: "R2.08", text: "Prog Objet (Python)" },
                    { code: "R2.09", text: "Dev Web Dynamique (PHP)" },
                    { code: "R2.13", text: "Maths du numerique" }
                ]
            },
            {
                label: "Semestres 3 et 4",
                items: [
                    { code: "R3.07", text: "Prog Systeme" },
                    { code: "R3.08", text: "Bases de Donnees (SQL)" },
                    { code: "R3.09", text: "Dev Web Avance" },
                    { code: "R4.06", text: "Scripting et Automatisation" }
                ]
            },
            {
                label: "Semestre 5",
                ...
                items: [
                    ...
                    { code: "R5.08", text: "Gestion de Projet" },
                    { code: "R5.05", text: "Communication Pro" }
                ]
            }
        ],
        resourceBadge: "En cours d'acquisition",
        saeTitle: "SAE Realisees",
        saeItems: [
            { text: "SAE 1.05 : Traitement de donnees" },
            { text: "SAE 2.03 : Application Web dynamique" },
            { text: "SAE 3.02 : App Communicantes" },
            { text: "SAE 5.01 : CyberFi (Scripting Python/MQTT)", highlight: true }
        ],
        objectivesTitle: "Objectifs Programme National",
    ...
    ue4: {
        ...
        resources: [
            {
                ...
                items: [
                    { code: "R1.06", text: "Hygiene Informatique" },
                    { code: "R2.06", text: "Securite Systemes" },
                    { code: "R3.10", text: "Crypto Fondamentale" },
                    { code: "R4.Cyber.01", text: "Securite Perimetrique" }
                ]
            },
            {
                label: "Semestre 5",
                ...
                items: [
                    { code: "R5.Cyber.09", text: "Archis Securisees" },
                    { code: "R5.Cyber.10", text: "Audits Secu" },
                    { code: "R5.Cyber.12", text: "Analyse de Risques" }
                ]
            }
        ],
        resourceBadge: "En cours d'acquisition",
        saeTitle: "SAE Realisees",
        saeItems: [
            { text: "SAE 1.01 : Hygiene informatique" },
            { text: "SAE 3.Cyber.03 : Reseau securise multi-sites" },
            { text: "SAE 5.Cyber.03 : Hardening et Architecture Cloisonnee", highlight: true }
        ],
        objectivesTitle: "Objectifs Programme National",
    ...
    ue5: {
        ...
        resources: [
            {
                label: "Semestres 1 a 4",
                items: [
                    { code: "R2.06", text: "Supervision Reseaux" },
                    { code: "R3.14", text: "Analyse Trafic (Wireshark)" },
                    { code: "R4.Cyber.02", text: "Forensics et Malware" },
                    { code: "R4.Cyber.03", text: "Pentesting Basique" }
                ]
            },
            {
                label: "Semestre 5",
                ...
                items: [
                    ...
                    { code: "R5.Cyber.11", text: "Supervision Securite (SIEM)" }
                ]
            }
        ],
        resourceBadge: "En cours d'acquisition",
        saeTitle: "SAE Realisees",
        saeItems: [
            { text: "SAE 3.Cyber.04 : Detecter un incident" },
            { text: "SAE 5.Cyber.03 : Supervision Avancee et SOC", highlight: true }
        ],
        objectivesTitle: "Objectifs Programme National",
